...
from src.classifiers import ConcatClassifierHead
from src.classifiers_v2 import MoEClassifierHead


class ModernBertForSentiment_v2(ModernBertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if classifier_input_size == config.hidden_size:
            self.classifier = MoEClassifierHead(
